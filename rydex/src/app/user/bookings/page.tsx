...
export const AutoRickshaw = ({ className, ...props }: IconProps) => {
  return (
    <svg
    ...
    >
      ...
      {/* Main body / cabin structure */}
      <path d="M4 18V13C4 10 6 7 10 7H16C18 7 20 9 20 12V18" />
      {/* Front windshield tilt */}
      <path d="M4 13L7 8H10" />
      {/* Passenger/Driver seating cutout open space */}
      <path d="M10 18V11H16V18" />
      {/* Handle bar indicator line */}
      <path d="M5 14H7" />
    </svg>
  );
};
...
function page() {
  ...
  const getVehicleIcon = (vehicleType?: string) => {
    switch (vehicleType?.toLowerCase()) {
      ...
      case "auto":
        return <AutoRickshaw className="w-4 h-4 text-gray-400" />; // You can add Auto icon if available
      case "truck":
                ...
                <div className="flex items-start sm:items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm sm:text-base text-gray-600">
                      ...
                      {bookings?.length === 1 ? "ride" : "rides"} assigned to
                      you.
                    </p>
                  </div>
                </div>
