...
function PanelContent({
  ...
  return (
    <div>
      {isActive && (
        <div className="mx-5 lg:mx-6 grid grid-cols-2 gap-2 mt-3">
          <div className="bg-zinc-50 border-zinc-100 rounded-2xl p-4 flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-zinc-100 flex items-center justify-center shrink-0">
              <Clock size={16} className="text-zinc-600" />
            </div>
            <div>
              <p className="text-[10px] text-zinc-800 uppercase tracking-wider font-semibold">
                ETA
              </p>
          ...
          <div className="bg-zinc-950 rounded-2xl p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-[10px] text-zinc-200 uppercase tracking-wider font-semibold">
                Fare
              </p>
      ...
      <AnimatePresence>
        {chatOpen && canChat && (
          ...
          >
            <div className="rounded-2xl mt-3 overflow-hidden border border-zinc-100 h-115">
              <RideChat
          ...
          <div className="bg-zinc-50 border border-zinc-100 rounded-2xl overflow-hidden">
            <div className="flex gap-3 p-4 border-b border-zinc-100">
              <div className="flex flex-col items-center shrink-0 pt-1">
                  ...
                  <div className="w-px bg-zinc-300 mt-1" style={{height:20}}/>
              </div>
              <div className="flex-1 min-w-0">
