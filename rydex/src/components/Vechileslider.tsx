                ...
                >
                  ...
                  >
                    <motion.div
                      animate={{
                        backgroundColor:
                          isHovered ? "rgba(255,255,255,0.12)" : "#f4f4f5",
                        color: isHovered ? "#ffffff" : "#71717a",
                        borderBlockColor:
                          isHovered ? "rgba(255,255,255,0.15" : "#e4e4e7",
                      }}
                    ...
                    <motion.div
                      animate={{
                        backgroundColor:
                          isHovered ? "rgba(255,255,255,0.1)" : "#f4f4f5",
                        borderColor:
                          isHovered ? "rgba(255,255,255,0.15)" : "#e4e4e7",
                      }}
                    ...
                    >
                      ...
                      >
                        <cat.Icon size={24} strokeWidth={1.2} />
                      </motion.div>
                    </motion.div>
