"use client";
import { statusType, vehicleType } from "@/models/vehicle.model";
...
function VehicleCard({
  ...
  return (
    <motion.div
      ...
      className="relative bg-white border border-zinc-200 rounded-3xl overflow-hidden cursor-pointer "
    ...
    >
      ...
      <div className="relative h-48 bg-zinc-50 flex items-center justify-center overflow-hidden">
        ...
        <motion.img
          ...
          className="relative z-10 max-h-32 w-auto object-contain"
          style={{
