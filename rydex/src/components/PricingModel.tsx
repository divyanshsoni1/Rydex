...
function PricingModel({ open, onClose, data }: Props) {
        ...
        >
          ...
          >
            ...
            <div className="p-6 space-y-6">
              <label
                htmlFor="imageLabel"
                className="relative h-50 border-2 border-dashed rounded-2xl flex items-center justify-center cursor-pointer"
              >
                {!preview ?
                  <ImagePlus size={28} />
                : <img
