...
function AdminEarning() {
  ...
  const max =
    earningData.length ? Math.max(...earningData.map((d) => d.earnings)) : 0;
  ...
  const deltaPct =
    yesterDay ? Math.abs(Math.round((delta / yesterDay.earnings) * 100)) : 0;
  ...
  return (
    <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 w-[90%] lg:w-[80%] mx-auto">
